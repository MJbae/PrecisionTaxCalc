...
public class FinalTaxService {
    ...
    private final SpecialDeductionService specialDeductionServiceCalc = new SpecialDeductionService();
    ...
    public BigDecimal calculate(Tax tax, BigDecimal retirementPensionDeduction) {
        ...
        BigDecimal specialDeduction = specialDeductionServiceCalc.calculate(tax);
